...
class NewGoodPage6 extends React.Component {
	...
	getData(){
		json("https://shop.juanpi.com/zxg?key=1295&type=1&zhouyi_ids=p8_c3_l1_18_51_5_151&machining=gsortzxg&page="+1+"&rows=10&dtype=JSONP&cm=1&cm_channel=1",{					
						param:'callback',
